...
<table>
	...
	<span style="float: right;">
	<a href="../1205Jtest/BulletinBoardTest.jsp">
		<button type="button" style="border-radius: 0.5em:padding:5px20px">글
			작성</button>
	</span>
	</br>
	<a href="../1204Jtest/ImageTest.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지1" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지2" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지3" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지4" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지5" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지6" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지7" />
	</a>
	<a href="../1201Jtest/center.jsp"> <img src="이미지.jfif"
		style="float: left; margin-right: 80px; margin-bottom: 60px;"
		"width="200" height="200" alt="테스트이미지8" />
	</a>
	</table>
</body>
</html>