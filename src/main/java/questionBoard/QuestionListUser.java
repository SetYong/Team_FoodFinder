    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("MBNUM") == null) {
            	request.getRequestDispatcher("/EXFFFF/Main/Main.jsp?sidePage=../Question/QuestionSide.jsp&contentPage=../Question/QuestionMyBoard.jsp").forward(request, response);
            } else {
	            ...
	            String pagingImg = QuestionPageUser.pagingStr(totalCount, pageSize, blockPage, pageNum, "../Main/Main.jsp?sidePage=../Question/QuestionSide.jsp&");
