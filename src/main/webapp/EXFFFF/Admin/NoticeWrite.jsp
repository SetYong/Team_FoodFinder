...
<script type="text/javascript">
    function updateForm() {
        ...
        if (selectedValue === "notice" || selectedValue === "check") {
            ...
            formContent.innerHTML = 
            	'<tr> <td style="width:5%;text-align: center;"> 제목 : </td> <td colspan = "2	"> <input type="text" name="title" style="width: 95%; height: 30px;"> </td> </tr>' +
                '<tr> <td></td><td> 타이틀 이미지 <input type ="file" name = "eventTitleImg"> </td> <td> 내용 이미지 <input type="file" name="eventImg" style="margin-left: 5%;"> </td> </tr>' +
                '<tr> <td colspan = "3"> <input type = "submit" value = "작성 완료" style=" margin-left: 35%; width: 20%; height: 35px; border-radius: 25%;border: 1px solid gray;"> </td> </tr>';
        } else {
...
<body>
    <form name="NoticeWriteForm" enctype="multipart/form-data" action="../Admin/AdminNoticewrite.do" method="post">
        <table style="width: 100%">
            <tr>
                <td colspan = "3" style="text-align: center;">종류 : 
                    <input type ="radio" name ="cate" value ="notice" onclick = "updateForm()"> 공지 
                    <input type ="radio" name ="cate" value ="check" onclick = "updateForm()"> 점검 
