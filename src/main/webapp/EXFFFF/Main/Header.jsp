...
%>
<label onclick="location.href='../Main/Main.jsp?sidePage=../MyPage/MyPageSide.jsp&contentPage=../MyPage/MyPageHome.do?MBNUM=<%=session.getAttribute("MBNUM")%>'" class="menu_mypage">마이페이지</label>
<%
}
%>
	</div>
